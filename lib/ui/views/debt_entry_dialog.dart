...
class _DebtEntryDialogState extends State<DebtEntryDialog> {
                  ...
                  children: <Widget>[
                    ...
                    debtorNameTextController.text.length > 0
                        ? InputChip(
                            avatar: CircleAvatar(
                              child:
                                  Text("${debtorNameTextController.text[0]}"),
                            ),
                            label: Text('${debtorNameTextController.text}'),
                        ...
                        : Flexible(
                            child: TypeAheadFormField(
                              textFieldConfiguration: TextFieldConfiguration(
                                  controller: debtorNameTextController),
  ...
  void actionSavePressed() {
    if (_formKey.currentState.validate()) {
      ...
      print('${debtorNameTextController.text} $description $currency $amount $badgeType $date');
    }
  }
}
